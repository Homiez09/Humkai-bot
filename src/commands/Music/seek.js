...
module.exports = {
  ...
  run: async (interaction, client) => {
    ...
    if (value * 1000 >= player.playing.length || value < 0)
      return msg.edit('Cannot seek beyond length of song');
    ...
    console.log(
      chalk.magenta(
        `[SLASHCOMMAND] Seek used by ${interaction.user.tag} from ${interaction.guild.name}`,
      ),
    );
  },
};
