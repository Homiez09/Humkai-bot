...
module.exports = {
  ...
  run: async (interaction, client) => {
    ...
    if (!player)
      return msg.edit('No song/s currently playing within this guild.');
    ...
    if (!value || value.toLowerCase() == 'current') {
      if (player.trackRepeat === false) {
        ...
        console.log(
          chalk.magenta(
            `[SLASHCOMMAND] Loop used by ${interaction.user.tag} from ${interaction.guild.name}`,
          ),
        );
      } else {
        ...
        console.log(
          chalk.magenta(
            `[SLASHCOMMAND] Unloop used by ${interaction.user.tag} from ${interaction.guild.name}`,
          ),
        );
      }
    } else if (value == 'all') {
      if (player.queueRepeat === true) {
        ...
        console.log(
          chalk.magenta(
            `[SLASHCOMMAND] Unloopall used by ${interaction.user.tag} from ${interaction.guild.name}`,
          ),
        );
      } else {
        ...
        console.log(
          chalk.magenta(
            `[SLASHCOMMAND] Loopall used by ${interaction.user.tag} from ${interaction.guild.name}`,
          ),
        );
      }
    }
