...
module.exports = {
  ...
  run: async (interaction, client) => {
    ...
    if (Number(value) <= 0 || Number(value) > 100)
      return msg.edit('You may only set the volume to 1-100');
    ...
    console.log(
      chalk.magenta(
        `[SLASHCOMMAND] Volume used by ${interaction.user.tag} from ${interaction.guild.name}`,
      ),
    );
  },
};
