...
module.exports = {
  ...
  run: async (interaction, client) => {
    ...
    if (value === 0)
      return msg.edit(
        `Cannot skip to a song that is already playing. To skip the current playing song type: \`/skip\``,
      );
    ...
    console.log(
      chalk.magenta(
        `[SLASHCOMMAND] Skipto used by ${interaction.user.tag} from ${interaction.guild.name}`,
      ),
    );
  },
};
