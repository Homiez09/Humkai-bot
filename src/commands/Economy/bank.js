          ...
          try {
              ...
              return interaction.reply({
                embeds: [
                  await new MessageEmbed()
                    .setDescription(':x: | คุณมีเงินในธนาคารไม่พอ!')
                    .setColor('RED'),
                ],
                ephemeral: false,
              });
            ...
            return interaction.reply({
              embeds: [
                new MessageEmbed()
                  .setDescription(
                    `:white_check_mark: | ถอนเงินจำนวน ${amount}${process.env.CURRENCY} เรียบร้อยแล้ว`,
                  )
                  .setColor('GREEN'),
              ],
              ephemeral: false,
        ...
        try {
          ...
          return interaction.reply({
            embeds: [
              await new MessageEmbed()
                .setDescription(
                  `:white_check_mark: | ฝากเงินจำนวน ${amount}${process.env.CURRENCY} เรียบร้อยแล้ว`,
                )
                .setColor('GREEN'),
            ],
            ephemeral: false,
